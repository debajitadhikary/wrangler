...
public interface DirectivesListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DirectivesParser#byteSize}.
	 * @param ctx the parse tree
	 */
	void enterByteSize(DirectivesParser.ByteSizeContext ctx);
	/**
	 * Exit a parse tree produced by {@link DirectivesParser#byteSize}.
	 * @param ctx the parse tree
	 */
	void exitByteSize(DirectivesParser.ByteSizeContext ctx);
	/**
	 * Enter a parse tree produced by {@link DirectivesParser#timeDuration}.
	 * @param ctx the parse tree
	 */
	void enterTimeDuration(DirectivesParser.TimeDurationContext ctx);
	/**
	 * Exit a parse tree produced by {@link DirectivesParser#timeDuration}.
	 * @param ctx the parse tree
	 */
	void exitTimeDuration(DirectivesParser.TimeDurationContext ctx);
	/**
