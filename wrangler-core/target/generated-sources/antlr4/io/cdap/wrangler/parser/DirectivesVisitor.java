...
public interface DirectivesVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DirectivesParser#byteSize}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitByteSize(DirectivesParser.ByteSizeContext ctx);
	/**
	 * Visit a parse tree produced by {@link DirectivesParser#timeDuration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTimeDuration(DirectivesParser.TimeDurationContext ctx);
	/**
